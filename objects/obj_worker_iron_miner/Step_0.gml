...
//go to resource
if(auto==1){
if(instance_number(obj_iron_pile)>0){//only if resource exists
    to_mine=instance_nearest(x,y,obj_iron_pile);
...
//make stockpile
if(mine>=mine_max){
instance_create(x,y+sprite_height,obj_iron_chunk_p1);
mine-=mine_max;
}
